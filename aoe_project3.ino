...
{ 
  ...
  void gameRunning(){
    ...
    long unsigned minutes = ((millis() - timeStart)/1000)/60;
    long unsigned seconds = ((millis() - timeStart)/1000)%60;
  
    sprintf(line1,"  timer:  %01lu:%02lu",(minutes),(seconds));
